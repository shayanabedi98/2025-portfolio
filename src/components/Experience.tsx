    ...
    <div className="margin relative">
      ...
      <div className="flex flex-col gap-6">
        ...
        <ExperienceItem
          ...
          dateRange="Oct 2024 - June 2025 • Contract role with startup"
          list={[
            ...
            "Conducted user testing on thousands of crypto transactions to evaluate usability and performance.",
            "Supported 5 blockchain networks during development and testing.",
          ]}
        />
        <ExperienceItem
