  ...
  return (
    <div className="relative">
      <button
        ...
        className="cursor-pointer top-[25%] absolute right-2 bg-accent/70 flex items-center justify-center rounded-full h-8 w-8 z-10 lg:hover:bg-accent/100 transition"
      >
        <ChevronRight />
      </button>
      <button
        ...
        className="cursor-pointer top-[25%] absolute left-2 bg-accent/70 flex items-center justify-center rounded-full h-8 w-8 z-10 lg:hover:bg-accent/100 transition"
      >
        <ChevronLeft />
      </button>
